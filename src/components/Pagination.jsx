 ...
 * Client-side slicing with built-in pageSize state.
 * Returns everything <Pagination> needs as a spread:
...
/**
 * <Pagination />
 * Material-style pagination bar matching the screenshot:
 *   [Items per page: ▾]   [X – Y of Z]   [|< < > >|]
 *
 * Props:
 *   page, setPage, totalPages, from, to, total — required
 *   pageSize, setPageSize                       — required for the dropdown
 */
export default function Pagination({ page, setPage, totalPages, from, to, total, pageSize, setPageSize }) {
  // Always render so the per-page dropdown is accessible even with few records
