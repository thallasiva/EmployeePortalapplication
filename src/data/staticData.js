...
export const STATIC_USERS = {
  ...
  "teamlead@yopmail.com": {
    password: "Test@123",
    role: 4,
    name: "Sarah Johnson",
    email: "teamlead@yopmail.com"
  },
  "recruiter@yopmail.com": {
    password: "Test@123",
    role: 5,
    name: "Mike Williams",
    email: "recruiter@yopmail.com"
  },
  "recruiter1@yopmail.com": {
    password: "Test@123",
    role: 5,
    name: "Mike Williams",
    email: "recruiter1@yopmail.com"
  },
  "recruiter2@yopmail.com": {
    password: "Test@123",
    role: 5,
    name: "Emily Chen",
...
{ role_id: 4, role_name: "Recruiter Team Lead" },
{ role_id: 5, role_name: "Recruiter" }];
