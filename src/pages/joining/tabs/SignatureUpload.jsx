...
/**
 * Shared signature image upload widget.
 * Stores the result in form.signaturePreview (base64 data-url).
 * One upload in any tab is reflected everywhere because it shares
 * the same form field.
 */
    ...
    <div>
      ...
      {preview ? (
        <div className="relative inline-flex flex-col items-start gap-2">
          <div className="border-2 border-[#d97706] rounded-xl overflow-hidden bg-white p-1.5" style={{ width: 260 }}>
            <img src={preview} alt="Signature" className="w-full object-contain" style={{ maxHeight: 80 }} />
          </div>
