...
import
  {
    ...
    ThumbsUp, ThumbsDown, CheckCircle, Filter, ArrowRight,
  } from "lucide-react";
import
  {
    allTickets, teamTickets, managerAction, updateTicketStatus, addComment,
        ...
        <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid #e2e8f0", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <h3 style={{ fontSize: 15, fontWeight: 700, color: "#1e293b", margin: 0, lineHeight: 1.4 }}>
                {ticket.subject}
              </h3>
            </div>
                  ...
                  <div>
                    ...
                    <div style={{ marginBottom: 8 }}>
                      ...
                      <textarea value={rejectMsg === "" ? "" : rejectMsg}
                        ...
                        rows={2}
                        style={{
                          width: "100%", padding: "7px 10px", border: "1px solid #dbe2ea",
                ...
                {step === "reject" && (
                  <div>
                    ...
                    <textarea value={rejectMsg} onChange={e => setRejectMsg(e.target.value)}
                      ...
                      rows={3}
                      style={{
                        width: "100%", padding: "8px 10px", border: "1px solid #dbe2ea",
                        borderRadius: 6, fontSize: 12, outline: "none", resize: "none",
              ...
              {ticket.comments.map((c, i) => (
                <div key={i} style={{ background: "#f8fafc", borderRadius: 8, padding: "10px 14px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                    <span style={{ fontSize: 12, fontWeight: 600, color: BRAND }}>{c.commented_by_name}</span>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 14, flexShrink: 0, flexWrap: "wrap", alignItems: "center" }}>
        <div style={{ position: "relative" }}>
          ...
          <input value={search} onChange={e => { setSearch(e.target.value); setPage(1); }}
            ...
            style={{
              height: 34, width: 200, paddingLeft: 28, paddingRight: 10,
        ...
        {(search || statusF || (!isAdminUser && teamF)) && (
          <button onClick={() => { setSearch(""); setStatusF(""); if (!isAdminUser) setTeamF(""); setPage(1); }}
            style={{
