...
import {
  ...
  FileCheck, RefreshCw, TrendingUp, Users,
} from "lucide-react";
...
/* ── colour palette for candidate status ────────────────────────────── */
const STATUS_COLORS = {
  "new":                    "#2563eb",
  "applied":                "#2563eb",
  "screening":              "#f59e0b",
...
function ReportsTab() {
  ...
  /* re-fetch pipeline when filters change */
  const applyFilter = () => {
    setRepLoading(true);
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        ...
        {/* Candidate pipeline (all-time from dashboard) */}
        ...
        {/* Funnel for selected date range */}
