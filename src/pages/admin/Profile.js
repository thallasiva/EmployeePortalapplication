...
import {
  ...
  MapPin, Phone, Globe, Mail, Building2,
} from "lucide-react";
        ...
        <div style={{ padding:"0 1.5rem 1.5rem" }}>
          <div style={{
            ...
            <div style={{ display:"flex", gap:16, alignItems:"flex-start" }}>
              ...
              <div>
                {/* Office label */}
                <div style={{ fontSize:10, fontWeight:800, color:"#f18200",
                ...
                <div style={{ display:"flex", alignItems:"flex-start", gap:5, marginTop:8 }}>
                  <MapPin size={13} color="#f18200" style={{ marginTop:2, flexShrink:0 }}/>
                  <div>
                    <div style={{ fontSize:12, color:"#374151", fontWeight:500, lineHeight:1.5 }}>
                      {NAT_SOFT.address}
                    </div>
            ...
            <div style={{
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                <div style={{ width:28, height:28, borderRadius:7, background:"#fff8f0",
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                ...
                <span style={{ fontSize:12, color:"#f18200", fontWeight:600 }}>
                  {NAT_SOFT.web}
                </span>
              </div>
            </div>
