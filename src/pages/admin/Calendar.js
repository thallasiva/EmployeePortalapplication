...
import {
  ...
  Gift, Plus, Star, Users, X, Umbrella } from
'lucide-react';
...
import { cssClass, joinClasses } from "../../utils/classStyles";const EVENT_TYPES = {
...
function EventChip({ type, label, onDelete }) {
  ...
  return (
    <div
      className={joinClasses("flex items-center gap-1 px-1.5 py-0.5 rounded text-[11px] font-medium leading-tight cursor-default group", cssClass(
            ...
            <div className="space-y-3">
                ...
                return (
                  <div key={i} className="flex items-start gap-3">
                      <div className={joinClasses("w-8 h-8 rounded-lg flex items-center justify-center text-base shrink-0", cssClass(
                      { background: cfg.bg }))}>
                        {cfg.icon}
                      </div>
                      ...
                      <span
                      className={joinClasses("text-[10px] px-2 py-0.5 rounded-full font-medium shrink-0", cssClass(
                        { background: cfg.bg, color: cfg.color }))}>
            ...
            <div className="grid grid-cols-2 gap-x-2 gap-y-1.5">
              ...
              <div
                ...
                onClick={() => setTypeFilter(typeFilter === key ? 'all' : key)}>
                  ...
                  <span className={joinClasses("w-2.5 h-2.5 rounded-full shrink-0", cssClass({ background: cfg.color }))} />
