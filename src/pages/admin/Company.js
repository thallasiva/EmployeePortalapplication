...
import { ChevronDown, Globe, Mail, MapPin, Phone, ExternalLink, Building2, Tag, Activity, CheckCircle2 } from 'lucide-react';
      ...
      <div className="px-6 flex gap-6 items-start">
        ...
        <div className="w-72 shrink-0 space-y-4">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="h-24 w-full" style={{ background: company.banner }} />
              ...
              <div className="-mt-8 mb-3">
                <div className="w-16 h-16 rounded-xl bg-white border-2 border-white shadow-md flex items-center justify-center overflow-hidden">
                  {company.logo
                    ...
                    : null}
                  <div className="w-full h-full bg-brand text-white text-xl font-bold items-center justify-center" style={{ display: company.logo ? 'none' : 'flex' }}>
                    {company.short[0]}
                  </div>
                </div>
              </div>
