...
import {
  ...
  Calendar, ClipboardList, Receipt, Loader2,
} from "lucide-react";
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p style={{ margin: "3px 0 0", fontSize: 12, color: "#94a3b8" }}>{description}</p>
        </div>
      </div>
      ...
      <button
        ...
        style={{
          ...
          padding: "9px 18px", borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: loading ? "not-allowed" : "pointer",
          background: loading ? "#f1f5f9" : iconBg, color: loading ? "#94a3b8" : iconColor,
          border: `1px solid ${loading ? "#e2e8f0" : iconColor + "55"}`, transition: "all 0.15s",
          marginTop: 4,
        }}
  ...
  return (
    <div style={{ padding: "0 0 40px" }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: "#1e293b" }}>Report Downloads</h2>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(310px, 1fr))", gap: 18 }}>
        ...
        >
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            <div>
              ...
              <input type="date" value={lsFrom} onChange={(e) => setLsFrom(e.target.value)} style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>To Date</label>
              <input type="date" value={lsTo} onChange={(e) => setLsTo(e.target.value)} style={inputStyle} />
            </div>
          </div>
        </ReportCard>
        ...
        >
          ...
          <div style={{ marginTop: 4 }}>
            ...
            <select value={ptState} onChange={(e) => setPtState(e.target.value)} style={{ ...inputStyle, width: "auto" }}>
        ...
        >
          ...
          <div style={{ marginTop: 4 }}>
            <label style={labelStyle}>Establishment Code (optional)</label>
            <input type="text" value={ecrCode} onChange={(e) => setEcrCode(e.target.value)}
              placeholder="e.g. 100272303987" style={inputStyle} />
          </div>
        </ReportCard>
