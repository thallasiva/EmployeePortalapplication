  ...
  return (
    <div className={joinClasses(`org-card${matched ? " org-card--highlight" : ""}`, cssClass(
      ...
      <div className={joinClasses("org-avatar", cssClass({ background: `${color}1a`, color }))}>
        {emp.profile_photo ?
        <img src={emp.profile_photo} alt={name} className={cssClass(
      ...
      <div className={cssClass({ display: "flex", gap: 4, justifyContent: "center", flexWrap: "wrap", marginTop: 4 })}>
        ...
        {isSelf &&
        <span className={cssClass({ fontSize: 9, fontWeight: 700, background: "#fff8f0", color: BRAND,
          border: `1px solid ${BRAND}`, borderRadius: 4, padding: "1px 5px" })}>YOU</span>
        }
        {badge && !isSelf &&
        <span className={cssClass({ fontSize: 9, fontWeight: 700, background: "#f5f3ff", color: "#7c3aed",
...
function VLine({ height = 36 }) {
  return <div className={cssClass({ width: 2, height, background: "#cbd5e1", margin: "0 auto" })} />;
}
  ...
  return (
    <div className={cssClass({ display: "flex", flexDirection: "column", alignItems: "center" })}>
      ...
      <div className={cssClass({ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 })}>
        ...
        title="Expand one more level up" className={cssClass(
        ...
        title="Collapse this level" className={cssClass(
          { width: 26, height: 26, borderRadius: "50%",
...
function Legend({ depts }) {
  ...
  return (
    <div className={cssClass({ display: "flex", flexWrap: "wrap", gap: "8px 18px", margin: "8px 0" })}>
      {depts.map((d) =>
      <span key={d.id} className={cssClass({ display: "flex", alignItems: "center", gap: 5,
        fontSize: 11, color: "#64748b" })}>
          <span className={cssClass({ width: 9, height: 9, borderRadius: "50%",
...
export default function OrganizationChart() {
  ...
  return (
    <div className={cssClass({
      ...
      {/* Header */}
      <div className={cssClass({ display: "flex", flexWrap: "wrap", justifyContent: "space-between",
        ...
        <div className={cssClass({ display: "flex", alignItems: "center", gap: 8 })}>
          ...
          <div className={cssClass({ position: "relative" })}>
            ...
            placeholder="Search people…" className={cssClass(
          ...
          {/* Zoom */}
          <div className={cssClass({ display: "flex", alignItems: "center", gap: 2, background: "#fff",
            border: "1px solid #dbe2ea", borderRadius: 8, height: 32, padding: "0 4px" })}>
            <button onClick={() => setZoom((z) => Math.max(40, z - 10))} className={cssClass(
            ...
            <button onClick={() => setZoom((z) => Math.min(160, z + 10))} className={cssClass(
              { background: "none", border: "none", cursor: "pointer",
                padding: 4, color: "#64748b", display: "flex" })}>
              <ZoomIn size={14} />
            </button>
            <button onClick={() => setZoom(100)} className={cssClass(
      ...
      <div className={cssClass({
        ...
        <div className={cssClass({
          ...
          <>
            ...
            <button
              onClick={() => setExpandedLevels(1)} className={cssClass(
                {
                  marginBottom: 12,
      ...
      {/* Footer hint */}
      <p className={cssClass({ fontSize: 10, color: "#94a3b8", textAlign: "center",
