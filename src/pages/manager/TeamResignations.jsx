...
import {
  ...
  ChevronDown, Paperclip, User, AlertTriangle,
} from "lucide-react";
    ...
    <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.45)", zIndex:1000,
      ...
      <div style={{ background:"#fff", borderRadius:16, width:"100%", maxWidth:520,
        ...
        <div style={{ padding:"18px 24px", borderBottom:"1px solid #f1f5f9",
          ...
          <div style={{ width:40, height:40, borderRadius:10, background:`${BRAND}15`,
            display:"flex", alignItems:"center", justifyContent:"center" }}>
            <LogOut size={18} color={BRAND}/>
          </div>
          <div>
            <p style={{ margin:0, fontSize:15, fontWeight:800, color:"#1e293b" }}>Review Resignation</p>
            <p style={{ margin:0, fontSize:12, color:"#94a3b8" }}>{row.employee_name}</p>
          </div>
        ...
        <div style={{ padding:"14px 24px", background:"#f8fafc", borderBottom:"1px solid #f1f5f9",
          ...
          {[
            ...
            <div key={l}>
              <p style={{ margin:"0 0 2px", fontSize:10, color:"#94a3b8", fontWeight:700,
        ...
        <div style={{ padding:"16px 24px", borderBottom:"1px solid #f1f5f9" }}>
          <p style={{ margin:"0 0 6px", fontSize:11, fontWeight:700, color:BRAND,
            textTransform:"uppercase", letterSpacing:"0.06em" }}>Reason for Resignation</p>
          <p style={{ margin:0, fontSize:13, color:"#374151", lineHeight:1.6 }}>{row.reason}</p>
        </div>
        ...
        <div style={{ padding:"14px 24px", borderBottom:"1px solid #f1f5f9",
          ...
          <div>
            ...
            <p style={{ margin:0, fontSize:13, fontWeight:600, color:"#1e293b" }}>{row.alternate_email || "—"}</p>
          </div>
          <div>
            <p style={{ margin:"0 0 2px", fontSize:10, color:"#94a3b8", fontWeight:700,
              textTransform:"uppercase" }}>Alternate Mobile</p>
            <p style={{ margin:0, fontSize:13, fontWeight:600, color:"#1e293b" }}>{row.alternate_mobile || "—"}</p>
          </div>
        </div>
        ...
        <div style={{ padding:"16px 24px", borderBottom:"1px solid #f1f5f9" }}>
          <label style={{ display:"block", fontSize:12, fontWeight:600, color:"#374151", marginBottom:6 }}>
            Your Comments <span style={{ color:"#94a3b8", fontWeight:400 }}>(optional)</span>
          </label>
        ...
        <div style={{ padding:"16px 24px", display:"flex", gap:10 }}>
          <button onClick={() => submit("rm_approved")} disabled={saving}
            style={{ flex:1, padding:"11px", borderRadius:9, fontWeight:700, fontSize:14,
          ...
          <button onClick={() => submit("rm_rejected")} disabled={saving}
            style={{ flex:1, padding:"11px", borderRadius:9, fontWeight:700, fontSize:14,
              border:"none", cursor: saving ? "not-allowed" : "pointer",
          ...
          <button onClick={onClose} disabled={saving}
            style={{ padding:"11px 18px", borderRadius:9, fontWeight:600, fontSize:14,
    ...
    <div style={{ background:"#fff", border:"1px solid #e2e8f0", borderRadius:12,
      ...
      <div style={{ padding:"14px 20px", display:"flex", alignItems:"center", gap:14,
        ...
        <div style={{ flex:1, minWidth:0 }}>
          <p style={{ margin:0, fontSize:14, fontWeight:700, color:"#1e293b" }}>{row.employee_name}</p>
          <p style={{ margin:0, fontSize:12, color:"#94a3b8" }}>
            {row.job_title || "—"} · {row.department_name || "—"}
          </p>
        </div>
        <div style={{ textAlign:"center" }}>
          <p style={{ margin:"0 0 1px", fontSize:10, color:"#94a3b8", fontWeight:600 }}>START DATE</p>
          <p style={{ margin:0, fontSize:13, fontWeight:700, color:"#1e293b" }}>{fmtDate(row.start_date)}</p>
        </div>
        <div style={{ textAlign:"center" }}>
          <p style={{ margin:"0 0 1px", fontSize:10, color:"#94a3b8", fontWeight:600 }}>END DATE</p>
          <p style={{ margin:0, fontSize:13, fontWeight:700, color:"#1e293b" }}>{fmtDate(row.end_date)}</p>
        </div>
        <div style={{ textAlign:"center" }}>
          <p style={{ margin:"0 0 1px", fontSize:10, color:"#94a3b8", fontWeight:600 }}>SHORTFALL</p>
        ...
        <div style={{ borderTop:"1px solid #f1f5f9" }}>
          <div style={{ padding:"16px 20px", display:"grid",
            ...
            <div style={{ gridColumn:"1/-1" }}>
              <p style={{ margin:"0 0 4px", fontSize:10, fontWeight:700, color:BRAND,
            ...
            {[
              ...
              <div key={l}>
                <p style={{ margin:"0 0 2px", fontSize:10, fontWeight:700, color:"#94a3b8",
                  textTransform:"uppercase" }}>{l}</p>
          ...
          {row.manager_remarks && (
            <div style={{ padding:"12px 20px", background:"#f0fdf4",
              ...
              <div>
                ...
                <p style={{ margin:0, fontSize:13, color:"#15803d" }}>{row.manager_remarks}</p>
              </div>
            </div>
          )}
          ...
          <div style={{ padding:"12px 20px", display:"flex", justifyContent:"flex-end" }}>
            {row.status === "pending" ? (
              <button onClick={() => onReview(row)}
                style={{ padding:"9px 24px", borderRadius:8, fontWeight:700, fontSize:13,
...
export default function TeamResignations() {
  ...
  return (
    <div style={{ padding:"24px", fontFamily:"inherit", minHeight:"100vh", background:"#f5f7fb" }}>
      <ManagerTabs/>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:24 }}>
        ...
        <div>
          <h1 style={{ margin:0, fontSize:20, fontWeight:800, color:"#1e293b" }}>Team Resignations</h1>
          <p style={{ margin:0, fontSize:12, color:"#94a3b8" }}>Review and approve your team's exit requests</p>
        </div>
        {pending > 0 && (
          <span style={{ marginLeft:"auto", padding:"6px 16px", borderRadius:999,
      ...
      <div style={{ display:"flex", gap:8, marginBottom:16, flexWrap:"wrap", alignItems:"center" }}>
        <div style={{ position:"relative", flex:1, minWidth:200 }}>
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            style={{ width:"100%", boxSizing:"border-box", height:38, paddingLeft:34, paddingRight:12,
      ...
      {loading ? (
        ...
        <div style={{ textAlign:"center", padding:60, color:"#94a3b8" }}>
          <LogOut size={40} color="#e2e8f0" style={{ marginBottom:12 }}/>
          <p style={{ margin:0 }}>No resignation requests found.</p>
        </div>
      ) : (
