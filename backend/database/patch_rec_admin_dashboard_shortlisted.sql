-- ============================================================
-- Patch: sp_rec_admin_dashboard — add shortlisted candidates
-- Adds a 5th result set: shortlisted candidates with HR name
-- Run: SOURCE patch_rec_admin_dashboard_shortlisted.sql
-- ============================================================
...
BEGIN
  ...
  -- result[4]: Shortlisted candidates with HR/recruiter name
  SELECT
    c.candidate_id,
    c.candidate_code,
