-- Patch: add duration_minutes to rec_interviews
-- Run AFTER patch_rec_interviews_enum.sql

ALTER TABLE rec_interviews
  ADD COLUMN duration_minutes INT NULL DEFAULT NULL AFTER interview_time;

-- Update the schedule SP to accept and store duration_minutes
...
-- Also add teams_join_url column
ALTER TABLE rec_interviews
  ADD COLUMN teams_join_url VARCHAR(1000) NULL DEFAULT NULL AFTER teams_end;
