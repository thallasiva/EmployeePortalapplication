-- ============================================================
-- Migration 042: Employee Salary Assignment
-- Assign a salary structure + CTC to each employee.
-- When generating payslip, look up this assignment and use
-- computeStructure() to build the component breakdown.
-- ============================================================
USE hrms_db;
...
SELECT 'Migration 042 complete — employee salary assignment SPs ready' AS status;
