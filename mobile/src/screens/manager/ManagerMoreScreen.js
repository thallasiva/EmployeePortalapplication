      ...
      <ScrollView>
        <LinearGradient colors={['#1a2535','#2d3748',COLORS.primary+'cc']} style={styles.banner}>
          ...
          <View style={{flex:1}}>
            ...
            <Text style={styles.bannerRole}>{user?.designation || user?.role_name || 'Manager'}</Text>
        ...
        {/* Team Management - matches web Reporting Manager sidebar additions */}
        <Section title="Team Management">
          <MenuItem icon="people-outline" label="Team Overview" desc="Team summary and KPIs" route={ROUTES.DASHBOARD} navigation={navigation} color={COLORS.primary} />
          <MenuItem icon="finger-print-outline" label="Team Attendance" desc="Today's attendance + regularizations" route="TeamAttendance" color={COLORS.success} navigation={navigation} />
          <MenuItem icon="calendar-outline" label="Leave Requests" desc="Approve or reject team leaves" route="TeamLeave" color={COLORS.info} navigation={navigation} />
          <MenuItem icon="refresh-circle-outline" label="Regularizations" desc="Approve attendance corrections" route={ROUTES.TEAM_REGULARIZATIONS} color="#0891b2" navigation={navigation} />
          <MenuItem icon="time-outline" label="Timesheets" desc="Review team work hours" route={ROUTES.TIMESHEETS} color={COLORS.warning} navigation={navigation} />
          <MenuItem icon="ribbon-outline" label="Appraisal" desc="Performance reviews for team" route={ROUTES.PERFORMANCE_ADMIN} color="#db2777" navigation={navigation} />
          <MenuItem icon="exit-outline" label="Resignations" desc="Team resignation requests" route={ROUTES.RESIGNATIONS} color={COLORS.danger} navigation={navigation} />
        </Section>

        {/* My Work */}
        <Section title="My Work (Team)">
          <MenuItem icon="bar-chart-outline" label="Reports" desc="Team and department reports" route={ROUTES.REPORTS} color="#059669" navigation={navigation} />
          <MenuItem icon="calendar-outline" label="Calendar" desc="Events and holidays" route={ROUTES.CALENDAR} color="#8b5cf6" navigation={navigation} />
        </Section>
